...
Ces cibles sont des hypothèses de travail issues de l'état de l'art (EER de 8 % à 10 % selon la modalité pour une décision isolée, amélioré par l'accumulation séquentielle). Elles seront révisées après le lot 3 avec les mesures réelles du poste, et toute révision sera justifiée et datée.
